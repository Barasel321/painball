tellraw @a ["",{"selector":"@s","bold":true,"color":"gold"},{"text":" has earned the [","bold":true,"italic":true,"color":"gold"},{"text":" Golden Fusion Rifle ","bold":true,"italic":true,"color":"light_purple"},{"text":"]","bold":true,"italic":true,"color":"gold"}]
...
scoreboard players add @s fusionkills 1